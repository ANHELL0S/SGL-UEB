...
import { ACCESS_APPROVED, ACCESS_PENDING, ACCESS_REJECTED } from '../../const/access-const.js'

export const access_lab_zod = z.object({
	full_name: z
		.string()
...
export const change_permission_acess_lab_zod = z.object({
