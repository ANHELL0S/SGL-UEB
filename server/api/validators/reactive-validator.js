...
import {
	...
	TONELADAS,
	UNIDADES,
} from '../../const/unitsMeasurement-const.js'

export const reactive_zod = z.object({
	name: z
		.string()
...
export const consumption_reactive_zod = z.object({
...
export const request_reactive_zod = z.object({
