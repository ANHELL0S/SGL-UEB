	...
	<>
		<div className='flex flex-col gap-y-1.5 w-full text-xs font-medium text-slate-500 dark:text-gray-300'>
			...
			<input
				...
				className={`w-full rounded-lg border-2 border-slate-200 bg-white px-3 py-2 focus:border-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-500 dark:text-gray-100 ${error ? 'dark:text-red-400 border-red-100 dark:border-red-400 dark:bg-red-400/5 bg-red-400/5 placeholder:text-red-400/0' : ''}`}
			/>
