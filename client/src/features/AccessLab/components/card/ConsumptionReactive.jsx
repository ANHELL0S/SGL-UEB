...
export const ConsumptionReactive = ({ accessData }) => {
	const {
		loading,
		error,
		page,
		...
		totalPages,
		consumptionData,
	} = useAllConsumptionPertainToAccessStore(accessData?.quote?.id_quote)
	...
	return (
		<>
			...
			{showCreatedModal && (
				<ModalCreateConsumption onClose={toggleCreatedModal} onSuccess={fetchConsumption} accessData={accessData} />
			)}
