...
import { applicant_schema_zod } from '../../../validators/applicantValidator'
...
export const ApplicantForm = ({ text, onSubmit, onClose, onChange, loading, formData }) => {
	...
	const {
		...
		resolver: zodResolver(applicant_schema_zod),
							...
							<motion.div
								...
								<form
									...
									<InputFieldZod
										...
										error={errors.name}
									/>
									<InputFieldZod label='Cédula' placeholder='Cédula' register={register('dni')} error={errors.dni} />
