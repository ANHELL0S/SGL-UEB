...
import { useCreated, useDelete, useUpdated, useStatus, useReport } from './hook/useCRUD'
		...
		if (reportData?.length === 0) {
			const notFoundProps = !search
				...
				: {
						...
						description: 'Lo sentimos, no se encontrarón reportes que coincidan con tu búsqueda.',
					}
			return (
