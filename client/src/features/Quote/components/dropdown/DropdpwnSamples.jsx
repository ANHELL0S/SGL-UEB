...
export const QuoteActionsSample = ({ sample, fetchData, quoteData }) => {
	...
	const {
		isVisible: showGenerateReportModal,
		openModal: openGenerateReport,
		closeModal: closeGenerateReport,
	} = useGenerateReportSample()
	const {
	...
	return (
		<>
			...
			{showUpdatedModal && (
				<ModalUpdateSample sample={selected} onClose={closeUpdated} onSuccess={fetchData} quoteData={quoteData} />
			)}

			{showAddResultModal && (
				<ModalCreateResult sample={selected} onClose={closeAddResult} onSuccess={fetchData} quoteData={quoteData} />
			)}

			{showUpdatedResultModal && (
				<ModalUpdateResult sample={selected} onClose={closeUpdatedResult} onSuccess={fetchData} quoteData={quoteData} />
			)}
			...
			{showReportSample && <ReportModal sample={selected} onClose={closeReportSample} quoteData={quoteData} />}
		</>
	)
}
