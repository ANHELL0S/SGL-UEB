...
export const LabSection = () => {
	...
	const {
		...
		openModal: handleAssignAnalyst,
		closeModal: toggleAssignAnalystModal,
	} = useAssignAnalyst()
	const handleOpenAssignAnalystModal = data => {
		setSelected(data)
		handleAssignAnalyst(data)
		toggleDropdown(null)
	}

	// DELETE ANALYST <-> LAB
	const {
		isVisible: showRemoveAnalystModal,
		openModal: handleRemoveAnalyst,
		closeModal: toggleRemoveAnalystModal,
	} = useRemoveAnalyst()
	const handleOpenRemoveAnalystModal = data => {
		setSelected(data)
		handleRemoveAnalyst(data)
		toggleDropdown(null)
	}
