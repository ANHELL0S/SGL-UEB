...
import { AccessTable } from '../components/Table/AcessTable'
import { NotFound } from '../../../components/Banner/NotFound'
import { Status500 } from '../../../components/Banner/StatusServer'
import { useAllAccessPertainToAnalystStore } from '../hook/useMeData'
...
export const AccessSection = () => {
	...
	} = useAllAccessPertainToAnalystStore()
	...
	const renderState = () => {
		...
		if (accessPertainToAnalystData?.length === 0) {
		...
		return <AccessTable accessPertainToAnalystData={accessPertainToAnalystData} />
	}
