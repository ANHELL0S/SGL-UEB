...
import { useAllQuotesPertainToAnalystStore } from '../hook/useMeData'
...
export const QuoteSection = () => {
	...
	} = useAllQuotesPertainToAnalystStore()
	...
	const renderState = () => {
		...
		if (quotesPertainToAnalystData?.length === 0) {
		...
		return <QuotesTable quotesPertainToAnalystData={quotesPertainToAnalystData} />
	}
