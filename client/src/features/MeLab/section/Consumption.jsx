...
import { ConsumptionTable } from '../components/Table/ConsumptionTable'
import { NotFound } from '../../../components/Banner/NotFound'
import { Status500 } from '../../../components/Banner/StatusServer'
import { useAllConsumptionPertainToAnalystStore } from '../hook/useMeData'
import { SpinnerLoading } from '../../../components/Loaders/SpinnerLoading'
import { Button } from '@/components/Button/Button'
import { useSelected } from '../hook/useSelected'
import { useDropdown } from '../hook/useDropdown'
import { useCreatedConsumption, useDeletedConsumption } from '../hook/useCRUD'
import { ModalCreateConsumption, ModalDeleteConsumption } from '../components/Form/Consumption/ConsumptionCRUD'
...
export const ConsumptionSection = () => {
	...
	} = useAllConsumptionPertainToAnalystStore()
	...
	const renderState = () => {
		...
		if (consumptionPertainToAnalystData?.length === 0) {
		...
		return (
			<ConsumptionTable
				consumptionPertainToAnalystData={consumptionPertainToAnalystData}
	...
	return (
		<>
			<main className='space-y-4 w-full h-full'>
			...
			{showCreatedModal && (
				<ModalCreateConsumption onClose={toggleCreatedModal} onSuccess={fetchConsumptionPertainToAnalyst} />
			)}
			{showDeletedPermanentModal && (
				<ModalDeleteConsumption
					onClose={toggleDeletedPermanentModal}
					consumption={selected}
					onSuccess={fetchConsumptionPertainToAnalyst}
				/>
			)}
		</>
	)
