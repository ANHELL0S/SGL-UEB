...
import { getReportLabsRequest } from '../../../../services/api/lab.api'
...
const ReportModal = ({ onClose }) => {
	...
	const fetchReportData = async () => {
		setLoading(true)
		try {
			await getReportLabsRequest(startDate, endDate)
			...
			{modalOpen && (
				<motion.div
					...
					<motion.div
						...
						<div className='space-y-4 text-xs dark:text-gray-300 text-slate-500'>
							<div>
