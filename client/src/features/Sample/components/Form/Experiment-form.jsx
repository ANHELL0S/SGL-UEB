...
export const ExperimentForm = ({ text, onSubmit, onClose, loading, formData }) => {
	const { loading: labsLoading, error, labData, setLimit } = useAllLabsStore()
	const [modalOpen, setModalOpen] = useState(true)
	const [selectedLab, setSelectedLab] = useState(formData?.id_lab)
							...
							<motion.div
								...
								<form
									...
									<div className='grid md:grid-cols-2 gap-4'>
										...
										<InputFieldZod
											label='Precio público'
											placeholder='Ingrese el precio interno'
											register={register('internal_price')}
